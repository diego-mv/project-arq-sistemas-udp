...
#------Servicios---------#
SERVICE_LOGIN = 'log23'
SERVICE_REGISTER = 'rgt23'
SERVICE_LIST_SALAS = 'sls23'
SERVICE_HOR_USADO_SALA = 'hus23'
SERVICE_CONFIRM_RES = 'scr23'
SERVICE_ADD_PARTICIPANTE_RESERV = 'apr23'
SERVICE_RESERV_REALIZADAS = 'rer23'
SERVICE_CANCEL_RESERV = 'car23'
SERVICE_CONFIRM_INV = 'cap23'
SERVICE_NUEVA_SALA = 'nsa23'
SERVICE_DELETE_SALA = 'bsa23'
SERVICE_TRAZABILIDAD = 'tra23'
                ...
                while userLogged:
                    ...
                    if(opt2 == 1): #realizar reserva
                        if GetFromService(SERVICE_LIST_SALAS) == 'OK':
                            ...
                            print('Cargando salas disponibles...')
                            while True: 
                                data_service_salas = socket.recv(390)
                                if str(data_service_salas)[12:]:
