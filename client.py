...
#------Servicios---------#
SERVICE_LOGIN = 'log13'
SERVICE_REGISTER = 'rgt13'
SERVICE_LIST_SALAS = 'sls13'
SERVICE_HOR_USADO_SALA = 'hus13'
SERVICE_CONFIRM_RES = 'scr13'
SERVICE_ADD_PARTICIPANTE_RESERV = 'apr13'
SERVICE_RESERV_REALIZADAS = 'rer13'
SERVICE_CANCEL_RESERV = 'car13'
SERVICE_CONFIRM_INV = 'cap13'
SERVICE_NUEVA_SALA = 'nsa13'
SERVICE_DELETE_SALA = 'bsa13'
SERVICE_TRAZABILIDAD = 'tra13'
