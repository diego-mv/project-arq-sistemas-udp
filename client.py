...
#------Servicios---------#
SERVICE_LOGIN = 'log15'
SERVICE_REGISTER = 'rgt15'
SERVICE_LIST_SALAS = 'sls15'
SERVICE_HOR_USADO_SALA = 'hus15'
SERVICE_CONFIRM_RES = 'scr15'
SERVICE_ADD_PARTICIPANTE_RESERV = 'apr15'
SERVICE_RESERV_REALIZADAS = 'rer15'
SERVICE_CANCEL_RESERV = 'car15'
SERVICE_CONFIRM_INV = 'cap15'
SERVICE_NUEVA_SALA = 'nsa15'
SERVICE_DELETE_SALA = 'bsa15'
SERVICE_TRAZABILIDAD = 'tra15'
