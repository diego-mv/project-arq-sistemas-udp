...
#------Servicios---------#
SERVICE_LOGIN = 'log55'
SERVICE_REGISTER = 'rgt55'
SERVICE_LIST_SALAS = 'sls55'
SERVICE_HOR_USADO_SALA = 'hus55'
SERVICE_CONFIRM_RES = 'scr55'
SERVICE_ADD_PARTICIPANTE_RESERV = 'apr55'
SERVICE_RESERV_REALIZADAS = 'rer55'
SERVICE_CANCEL_RESERV = 'car55'
SERVICE_CONFIRM_INV = 'cap55'
SERVICE_NUEVA_SALA = 'nsa55'
SERVICE_DELETE_SALA = 'bsa55'
