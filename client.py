...
#------Servicios---------#
SERVICE_LOGIN = 'log56'
SERVICE_REGISTER = 'rgt56'
SERVICE_LIST_SALAS = 'sls56'
SERVICE_HOR_USADO_SALA = 'hus56'
SERVICE_CONFIRM_RES = 'scr56'
SERVICE_ADD_PARTICIPANTE_RESERV = 'apr56'
SERVICE_RESERV_REALIZADAS = 'rer56'
SERVICE_CANCEL_RESERV = 'car56'
SERVICE_CONFIRM_INV = 'cap56'
SERVICE_NUEVA_SALA = 'nsa56'
SERVICE_DELETE_SALA = 'bsa56'
SERVICE_TRAZABILIDAD = 'tra56'
