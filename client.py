...
SERVICE_LIST_SALAS = 'sls10'
SERVICE_HOR_USADO_SALA = 'hus10'
SERVICE_CONFIRM_RES = 'scr10'
SERVICE_ADD_PARTICIPANTE_RESERV = 'apr10'
SERVICE_RESERV_REALIZADAS = 'rer10'
SERVICE_CANCEL_RESERV = 'car10'
SERVICE_CONFIRM_INV = 'cap10'
SERVICE_NUEVA_SALA = 'nsa10'
SERVICE_DELETE_SALA = 'bsa10'
SERVICE_TRAZABILIDAD = 'tra10'
