...
#------Servicios---------#
SERVICE_LOGIN = 'log00'
SERVICE_REGISTER = 'rgt00'
SERVICE_LIST_SALAS = 'sls00'
SERVICE_HOR_USADO_SALA = 'hus00'
SERVICE_CONFIRM_RES = 'scr00'
SERVICE_ADD_PARTICIPANTE_RESERV = 'apr00'
SERVICE_RESERV_REALIZADAS = 'rer00'
SERVICE_CANCEL_RESERV = 'car00'
SERVICE_CONFIRM_INV = 'cap00'
SERVICE_NUEVA_SALA = 'nsa00'
SERVICE_DELETE_SALA = 'bsa00'
SERVICE_TRAZABILIDAD = 'tra00'
